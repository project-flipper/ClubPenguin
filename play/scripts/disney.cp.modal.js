...
Disney.CP.Modal = function (options) {
...
Disney.CP.Modal.prototype.inject = function () {
...
Disney.CP.Modal.prototype.attach = function () {
	var self = this;
...
Disney.CP.Modal.prototype.centerElement = function (element) {
	// usefull dimensions
...
Disney.CP.Modal.prototype.positionOverlay = function () {
	// ie6 alternate overlay size other browsers use css
	if (jQuery.browser.msie && jQuery.browser.version === '6.0') {
		this.overlay.css('height', jQuery(document).height());
	}
};
Disney.CP.Modal.prototype.positionModal = function () {
	this.centerElement(this.modal);
};
Disney.CP.Modal.prototype.showLoading = function () {
	if (this.isOpen) {
...
Disney.CP.Modal.prototype.open = function (modalContent, openCallback, closeCallback) {
	var self = this;
	if (!this.isOpen) {
		if (this.isLoading) {
...
Disney.CP.Modal.prototype.close = function (callback) {
	if (this.isOpen) {
		var self = this;
