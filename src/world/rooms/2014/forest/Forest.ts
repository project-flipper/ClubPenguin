...
export default class Forest extends Phaser.Scene implements Room {
    ...
    preload(): void {
        ...
        this.load.pack("forest-pack", "assets/world/rooms/2014/forest/forest-pack.json");
    }

    editorCreate(): void {

        // forest_sky
        const forest_sky = this.add.image(-130.6125, -44.8875, "forest", "forest/sky");
        forest_sky.setOrigin(0, 0);

        // forest_base
        const forest_base = this.add.image(-153, -53.325, "forest", "forest/base");
        forest_base.setOrigin(0, 0);

        // forest_bush
        const forest_bush = this.add.image(426.825, 298.35, "forest", "forest/bush");
        forest_bush.setOrigin(0.8333333333333334, 0.5720338983050848);

        // forest_bush1
        const forest_bush1 = this.add.image(443.25, 320.175, "forest", "forest/bush1");
        forest_bush1.setOrigin(0, 0.6477272727272727);

        // forest_tree1
        const forest_tree1 = this.add.image(397.0125, 337.1625, "forest", "forest/tree1");
        forest_tree1.setOrigin(0.37375415, 0.93766265);

        // forest_bush2
        const forest_bush2 = this.add.image(429.1875, 354.4875, "forest", "forest/bush2");
        forest_bush2.setOrigin(0, 0.631578947368421);

        // forest_trunk1
        const forest_trunk1 = this.add.image(443.1375, 374.5125, "forest", "forest/trunk1");
        forest_trunk1.setOrigin(0, 0.5526315789473685);

        // forest_shadow2
        const forest_shadow2 = this.add.image(1221.75, 347.7375, "forest", "forest/shadow2");
        forest_shadow2.setOrigin(0.5, 0.85666667);

        // forest_shadow1
        const forest_shadow1 = this.add.image(1221.75, 352.0125, "forest", "forest/shadow1");
        forest_shadow1.setOrigin(0.5, 0.86273381);

        // forest_shadow
        const forest_shadow = this.add.image(1221.75, 355.5, "forest", "forest/shadow");
        ...
        // forest_tree
        const forest_tree = this.add.image(881.1, 369.45, "forest", "forest/tree");
        forest_tree.setOrigin(0.91836735, 1.09375);

        // forest_rock
        const forest_rock = this.add.image(930.825, 371.25, "forest", "forest/rock");
        forest_rock.setOrigin(0.9375, 0.5547945205479452);

        // forest_cave
        const forest_cave = this.add.image(1173.6, 357.6375, "forest", "forest/cave");
        forest_cave.setOrigin(0.3515625, 0.84965035);

        // forest_rock1
        const forest_rock1 = this.add.image(1296.3375, 384.6375, "forest", "forest/rock1");
        forest_rock1.setOrigin(0, 0.3125);

        // forest_trunk
        const forest_trunk = this.add.image(1018.35, 403.425, "forest", "forest/trunk");
        forest_trunk.setOrigin(0.97826087, 0.43994413);

        // forest_isleright
        const forest_isleright = this.add.image(1312.425, 605.1375, "forest", "forest/isleright");
        forest_isleright.setOrigin(0.99753695, 0.48387097);

        // forest_tree2
        const forest_tree2 = this.add.image(891.225, 644.85, "forest", "forest/tree2");
        forest_tree2.setOrigin(0.7978723404255319, 0.759375);

        // forest_isleleft
        const forest_isleleft = this.add.image(450.5625, 680.2875, "forest", "forest/isleleft");
        forest_isleleft.setOrigin(0, 0.6234939759036144);

        // forest_bush4
        const forest_bush4 = this.add.image(1505.7, 781.875, "forest", "forest/bush4");
        forest_bush4.setOrigin(0, 0.46621622);

        // forest_arrow
        const forest_arrow = this.add.image(1544.625, 799.9875, "forest", "forest/arrow");
        forest_arrow.setOrigin(0, 0.77083333);

        // forest_stairs
        const forest_stairs = this.add.image(1525.05, 852.3, "forest", "forest/stairs");
        forest_stairs.setOrigin(0.4090909090909091, 0.35611510791366907);

        // forest_rock2
        const forest_rock2 = this.add.image(688.275, 910.8, "forest", "forest/rock2");
        forest_rock2.setOrigin(0, 0.32142857);

        // forest_bush3
        const forest_bush3 = this.add.image(1599.1875, 511.08750000000003, "forest", "forest/bush3");
        forest_bush3.setOrigin(0, 0.6107142857142858);

        // forest_tree3
        const forest_tree3 = this.add.image(1669.95, 557.1, "forest", "forest/tree3");
        forest_tree3.setOrigin(0.35856574, 0.9202544);

        // forest_tree4
        const forest_tree4 = this.add.image(1524.4875, 519.6375, "forest", "forest/tree4");
        forest_tree4.setOrigin(0, 0.62824675);

        // forest_rock3
        const forest_rock3 = this.add.image(1632.4875, 561.7125, "forest", "forest/rock3");
        forest_rock3.setOrigin(0.18, 0.34615385);

        // forest_tree5
        const forest_tree5 = this.add.image(1703.025, 597.7125, "forest", "forest/tree5");
        forest_tree5.setOrigin(0, 0.71808511);

        // forest_bush5
        const forest_bush5 = this.add.image(311.9625, 668.925, "forest", "forest/bush5");
        forest_bush5.setOrigin(0.86909871, 0.60483871);

        // forest_bush6
        const forest_bush6 = this.add.image(274.3875, 682.5375, "forest", "forest/bush6");
        forest_bush6.setOrigin(0.78671329, 0.38942308);

        // forest_bush7
        const forest_bush7 = this.add.image(37.6875, 560.5875, "forest", "forest/bush7");
        forest_bush7.setOrigin(1.02791878, 0.71052632);

        // forest_tree6
        const forest_tree6 = this.add.image(17.325, 656.8875, "forest", "forest/tree6");
        forest_tree6.setOrigin(0.9, 0.75663717);

        // forest_bush8
        const forest_bush8 = this.add.image(70.9875, 715.8375, "forest", "forest/bush8");
        forest_bush8.setOrigin(1.0546875, 0.64285714);

        // forest_bush9
        const forest_bush9 = this.add.image(56.7, 773.1, "forest", "forest/bush9");
        forest_bush9.setOrigin(0.9166666666666666, 0.6262886597938144);

        // bigrock
        const bigrock = this.add.image(177.075, 788.9625, "forest", "forest/bigrock");

        // forest_foreground
        const forest_foreground = this.add.image(-153.45, 426.6, "forest", "forest/foreground");
        forest_foreground.setOrigin(0, 0);

        // block
        const block = this.add.image(0, 0, "forest", "forest/block");
        block.setOrigin(0, 0);
        block.visible = false;

        // trash1_btn
        const trash1_btn = this.add.image(177.075, 788.9625, "forest", "forest/trash1_btn0004");
        ...
        // trash2_btn
        const trash2_btn = this.add.image(-23.7375, 760.5, "forest", "forest/trash2_btn0004");
        ...
        // forest_plaza_mc
        const forest_plaza_mc = this.add.image(-3.2625, 288.1125, "forest", "forest/plaza_mc");
        forest_plaza_mc.setOrigin(0, 0);
        forest_plaza_mc.visible = false;

        // forest_cove_mc
        const forest_cove_mc = this.add.image(1539.1125, 995.625, "forest", "forest/cove_mc");
        forest_cove_mc.visible = false;

        // forest_shack_mc
        const forest_shack_mc = this.add.image(1602.3375, 303.8625, "forest", "forest/shack_mc");
        forest_shack_mc.setOrigin(1, 0);
        forest_shack_mc.visible = false;

        // forest_what_mc
        const forest_what_mc = this.add.image(114.975, 762.3, "forest", "forest/what_mc");
    ...
    create(data: any) {
        ...
        this.trash1_btn.on('over', () => {
            ...
            this.sound.play('forest_rockrollout');
        });
        this.trash2_btn.on('over', () => {
            ...
            this.sound.play('forest_rockrollin');
        });
    ...
    unload(engine: Engine): void {
        ...
        engine.app.unloadAssetPack('forest-pack');
    }
