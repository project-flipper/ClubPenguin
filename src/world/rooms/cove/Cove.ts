...
export default class Cove extends Phaser.Scene {
    ...
    preload(): void {
        ...
        this.load.pack("cove-pack", "assets/world/rooms/cove/cove-pack.json");
    }
    ...
    create(data: any) {
        ...
        this.binoculars_btn.on('release', () => this.interface.loadContent(async () => (await import('../../interface/content/binoculars/Binoculars')).default));
