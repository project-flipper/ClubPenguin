...
export default class Coffee extends Phaser.Scene implements Room {
    ...
    preload(): void {
        ...
        this.load.pack("coffee2013-pack", "assets/world/rooms/2013/coffee/coffee2013-pack.json");
    }

    editorCreate(): void {

        // coffee_base
        const coffee_base = this.add.image(-157.5, -37.9125, "coffee2013", "coffee/base");
        coffee_base.setOrigin(0, 0);

        // coffee_upstairs
        const coffee_upstairs = this.add.image(1346.625, 154.2375, "coffee2013", "coffee/upstairs");
        coffee_upstairs.setOrigin(0, 0);

        // sign
        const sign = this.add.image(1388.3625, 179.4375, "coffee2013", "coffee/sign0001");
        sign.setOrigin(0, 0);

        // coffee_stairslight
        const coffee_stairslight = this.add.image(1461.4875, 48.0375, "coffee2013", "coffee/stairslight");
        coffee_stairslight.setOrigin(0.0689916, 0);

        // stairslight
        const stairslight = this.add.image(1376.5, 298.5, "coffee2013", "coffee/stairs-btn0002");
        ...
        // coffee_window
        const coffee_window = this.add.image(329.625, 52.987500000000004, "coffee2013", "coffee/window");
        coffee_window.setOrigin(0, 0);

        // door
        const door = this.add.image(715.95, 113.625, "coffee2013", "coffee/door0001");
        door.setOrigin(0, 0);

        // coffee_ceiling
        const coffee_ceiling = this.add.image(872.325, -31.3875, "coffee2013", "coffee/ceiling");
        coffee_ceiling.setOrigin(-0.00178, 0.05478);

        // coffee_ceilinglamp1
        const coffee_ceilinglamp1 = this.add.image(921.7125, 23.175, "coffee2013", "coffee/ceilinglamp1");
        coffee_ceilinglamp1.setOrigin(0, 0);

        // coffee_ceilinglamp2
        const coffee_ceilinglamp2 = this.add.image(942.4125, -3.0375, "coffee2013", "coffee/ceilinglamp2");
        coffee_ceilinglamp2.setOrigin(0, 0);

        // coffee_ceilinglamp3
        const coffee_ceilinglamp3 = this.add.image(966.825, -33.8625, "coffee2013", "coffee/ceilinglamp3");
        coffee_ceilinglamp3.setOrigin(0, 0);

        // coffee_countertable
        const coffee_countertable = this.add.image(1073.3625, 312.975, "coffee2013", "coffee/countertable");
        coffee_countertable.setOrigin(0.05315018, 0.04109635);

        // coffee_countertrash
        const coffee_countertrash = this.add.image(963, 294, "coffee2013", "coffee/countertrash");
        coffee_countertrash.setOrigin(0, 0);

        // coffee_counter
        const coffee_counter = this.add.image(882.9, 413.1, "coffee2013", "coffee/counter");
        coffee_counter.setOrigin(0, 0.4356779661016949);

        // coffee_machine1
        const coffee_machine1 = this.add.image(1056.375, 197.2125, "coffee2013", "coffee/machine1");
        coffee_machine1.setOrigin(0, 0);

        // coffee_machine2
        const coffee_machine2 = this.add.image(1112.175, 190.0125, "coffee2013", "coffee/machine2");
        coffee_machine2.setOrigin(0, 0);

        // coffee_dispenser1
        const coffee_dispenser1 = this.add.image(1177.0875, 302.9625, "coffee2013", "coffee/dispenser1");
        coffee_dispenser1.setOrigin(0, 0);

        // coffee_dispenser2
        const coffee_dispenser2 = this.add.image(1204.3125, 332.6625, "coffee2013", "coffee/dispenser2");
        coffee_dispenser2.setOrigin(0, 0);

        // coffee_dispenser3
        const coffee_dispenser3 = this.add.image(1234.9125, 362.25, "coffee2013", "coffee/dispenser3");
        coffee_dispenser3.setOrigin(0, 0);

        // coffee_lamp
        const coffee_lamp = this.add.image(535.8375, -1.0125, "coffee2013", "coffee/lamp");
        coffee_lamp.setOrigin(0, 0);

        // coffee_lamp_1
        const coffee_lamp_1 = this.add.image(375.75, -0.7875, "coffee2013", "coffee/lamp");
        coffee_lamp_1.setOrigin(0, 0);

        // coffee_plant
        const coffee_plant = this.add.image(278.1, 150.75, "coffee2013", "coffee/plant");
        coffee_plant.setOrigin(0, 0);

        // coffee_frontcouch
        const coffee_frontcouch = this.add.image(360.45, 225.45000000000002, "coffee2013", "coffee/frontcouch");
        coffee_frontcouch.setOrigin(0, 0);

        // coffee_sidecouch
        const coffee_sidecouch = this.add.image(286.2, 327.4875, "coffee2013", "coffee/sidecouch");
        coffee_sidecouch.setOrigin(0.71300469, 0.24167464);

        // coffee_sidecouchrest
        const coffee_sidecouchrest = this.add.image(189.45, 444.6, "coffee2013", "coffee/sidecouchrest");
        coffee_sidecouchrest.setOrigin(0, 0.55359375);

        // coffee_smallcouch
        const coffee_smallcouch = this.add.image(209.1375, 491.9625, "coffee2013", "coffee/smallcouch");
        coffee_smallcouch.setOrigin(0, 0.24691056910569106);

        // coffee_rug
        const coffee_rug = this.add.image(383.7375, 388.575, "coffee2013", "coffee/rug");
        coffee_rug.setOrigin(0, 0);

        // coffee_table
        const coffee_table = this.add.image(419.85, 444.6, "coffee2013", "coffee/table");
        coffee_table.setOrigin(0, 0.516530612244898);

        // coffee_railing
        const coffee_railing = this.add.image(200.8125, 569.475, "coffee2013", "coffee/railing");
        coffee_railing.setOrigin(0.07281378, 0.36818182);

        // coffee_carpet
        const coffee_carpet = this.add.image(518.0625, 699.975, "coffee2013", "coffee/carpet");
        coffee_carpet.setOrigin(0, 0);

        // register
        const register = this.add.sprite(954.5625, 498.825, "coffee2013", "coffee/register0001");
        register.setOrigin(-0.06234, 0.6347);

        // coffee_downtable
        const coffee_downtable = this.add.image(933.4125, 861.6375, "coffee2013", "coffee/downtable");
        coffee_downtable.setOrigin(0, 0.60641);

        // coffee_beanbag
        const coffee_beanbag = this.add.image(1352.1375, 781.3125, "coffee2013", "coffee/beanbag");
        coffee_beanbag.setOrigin(0.43916, 0.24105);

        // coffee_couchcushion
        const coffee_couchcushion = this.add.image(1132.2, 741.4875, "coffee2013", "coffee/couchcushion");
        coffee_couchcushion.setOrigin(0.00056, 0.04003);

        // coffee_couchback
        const coffee_couchback = this.add.image(1357.875, 776.025, "coffee2013", "coffee/couchback");
        coffee_couchback.setOrigin(0.50768, 0.23824);

        // coffee_singlecouchcushion
        const coffee_singlecouchcushion = this.add.image(717.975, 773.8875, "coffee2013", "coffee/singlecouchcushion");
        coffee_singlecouchcushion.setOrigin(0, -0.25869);

        // coffee_singlecouchback
        const coffee_singlecouchback = this.add.image(705.0375, 774.7875, "coffee2013", "coffee/singlecouchback");
        coffee_singlecouchback.setOrigin(0, 0.22424);

        // coffee_singlecouchrest
        const coffee_singlecouchrest = this.add.image(720.5625, 853.5375, "coffee2013", "coffee/singlecouchrest");
        coffee_singlecouchrest.setOrigin(0, 0.26645);

        // coffee_smoothiebg
        const coffee_smoothiebg = this.add.image(55.4625, 611.1, "coffee2013", "coffee/smoothiebg");
        coffee_smoothiebg.setOrigin(0.33887, 0.33389);

        // coffee_smoothietable
        const coffee_smoothietable = this.add.image(56.8125, 765.45, "coffee2013", "coffee/smoothietable");
        coffee_smoothietable.setOrigin(0.22907, 0.18971);

        // smoothieregister
        const smoothieregister = this.add.sprite(256.1625, 769.95, "coffee2013", "coffee/smoothieregister0001");
        smoothieregister.setOrigin(-0.00175, 0.94688);

        // blender
        const blender = this.add.sprite(122.85, 882.225, "coffee2013", "coffee/smoothieblender0001");
        blender.setOrigin(0.49237, 0.68276);

        // smoothielight
        const smoothielight = this.add.image(-111.375, 783.6125, "coffee2013", "coffee/smoothie-btn0002");
        smoothielight.setOrigin(0, 0.82645);
        smoothielight.visible = false;

        // coffee_smoothiefront
        const coffee_smoothiefront = this.add.image(124.3125, 933.1875, "coffee2013", "coffee/smoothiefront");
        coffee_smoothiefront.setOrigin(0.69728, 1.53401);

        // coffee_smoothiesign
        const coffee_smoothiesign = this.add.image(-40.95, 272.3625, "coffee2013", "coffee/smoothiesign");
        coffee_smoothiesign.setOrigin(0, 0);

        // smoothietitle
        const smoothietitle = this.add.image(-40.95, 272.3625, "coffee2013", "coffee/smoothietitle0001");
        smoothietitle.setOrigin(0, 0);

        // coffee_smoothiechair
        const coffee_smoothiechair = this.add.image(446.9625, 742.6125, "coffee2013", "coffee/smoothiechair");
        coffee_smoothiechair.setOrigin(0.08265, 0.16463);

        // coffee_smoothiechair_1
        const coffee_smoothiechair_1 = this.add.image(423, 868.725, "coffee2013", "coffee/smoothiechair");
        coffee_smoothiechair_1.setOrigin(0.08265, 0.16463);

        // beans
        const beans = this.add.sprite(1521.225, 861.975, "coffee2013", "coffee/beans0001");
        beans.setOrigin(0.42226131, 0.41206395);

        // coffee_shopouter
        const coffee_shopouter = this.add.image(85.1625, 1015.425, "coffee2013", "coffee/shopouter");
        coffee_shopouter.setOrigin(0.12928, 0.91449);

        // coffee_beanssign
        const coffee_beanssign = this.add.image(1585.2375, 370.0125, "coffee2013", "coffee/beanssign");
        ...
        // coffee_door_trigger
        const coffee_door_trigger = this.add.image(801.3375, 343.0125, "coffee2013", "coffee/door-trigger");
        coffee_door_trigger.visible = false;

        // beans_trigger
        const beans_trigger = this.add.image(1591.2, 871.65, "coffee2013", "coffee/beans-trigger");
        beans_trigger.visible = false;

        // coffee_upstairs_trigger
        const coffee_upstairs_trigger = this.add.image(1471.5, 421.7625, "coffee2013", "coffee/upstairs-trigger");
        ...
        doorButtonComponent.upTexture = {"key":"coffee2013","frame":"coffee/door0001"};
        doorButtonComponent.overTexture = {"key":"coffee2013","frame":"coffee/door0002"};
    ...
    create(data: any): void {
        ...
        this.smoothie_btn.on('out', () => {
            this.sound.stopByKey('coffee2013-blender');
            this.blender.play('coffee2013-blender-idle-animation');
            this.smoothielight.visible = false;
            this.interface.hideHint();
        });
        this.smoothie_btn.on('release', () => this.world.move(153, 731.25));

        this.door.on('over', () => this.sound.play('coffee2013-dooropen'));
        this.door.on('out', () => this.sound.play('coffee2013-doorclose'));
        this.door.on('release', () => this.world.move(798.75, 337.5));

        this.beansarea.on('over', () => {
            this.sound.play('coffee2013-beans');
            this.beans.play('coffee2013-beans-animation');
            this.interface.showLocalizedHint({ x: 1530.225, y: 720.22500 }, 'beans_hint');
        });
        this.beansarea.on('out', () => {
            this.beans.play('coffee2013-beans-idle-animation');
            this.interface.hideHint();
        });
        ...
        this.register_btn.on('over', () => {
            ...
            if (!this.cashOpen) {
                this.sound.play('coffee2013-registeropen');
                this.register.play('coffee2013-cashopen-animation');
                this.cashOpen = true;
            } else {
                this.sound.play('coffee2013-registerclose');
                this.register.play('coffee2013-cashclose-animation');
                this.cashOpen = false;
            }
        });
        ...
        this.smoothieregister_btn.on('over', () => {
            ...
            if (!this.smoothieCashOpen) {
                this.sound.play('coffee2013-registeropen');
                this.smoothieregister.play('coffee2013-smoothiecashopen-animation');
                this.smoothieCashOpen = true;
            } else {
                this.sound.play('coffee2013-registerclose');
                this.smoothieregister.play('coffee2013-smoothiecashclose-animation');
                this.smoothieCashOpen = false;
            }
        });
    ...
    unload(engine: Engine): void {
        ...
        engine.app.unloadAssetPack('coffee2013-pack');
    }
