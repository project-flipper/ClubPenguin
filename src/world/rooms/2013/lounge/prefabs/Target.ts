...
export default class Target extends Phaser.GameObjects.Container {
    ...
    constructor(scene: Phaser.Scene, x?: number, y?: number) {
        ...
        // art
        const art = scene.add.sprite(-36.25, -36, "lounge2013", "lounge/bluetarget");
        art.setOrigin(0, 0);
        this.add(art);

        // hitbox
        const hitbox = scene.add.image(0, 0, "lounge2013", "lounge/targethitbox");
    ...
    set team(value: string) {
        this._team = value;
        this.art.setFrame(`lounge/${value}target`);
    }
    ...
    hit(): void {
        ...
        this.art.play(`lounge2013-${this.team}target-animation`);
        this.art.once('animationcomplete', () => this.hide());
    }

    show(): void {
        this.visible = true;
        this.art.setFrame(`lounge/${this.team}target`);
