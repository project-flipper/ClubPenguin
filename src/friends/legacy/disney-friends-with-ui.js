...
var Disney = window.Disney || {};
window.Disney = Disney;
...
Disney.Social = {
    ...
    getJavascriptSafeUrl: function (e) {
        ...
        return i + e + "?v=" + DISNEY_FRIENDS_INI.VERSION
    },
    getUrlVars: function () {
    ...
    augmentTypes: function () {
        var e;
        Function.prototype.bind || (Function.prototype.bind = (e = Array.prototype.slice, function (i) {
            var n = this;
...
Disney.Social.Environment = {
    ...
    CLUBPENGUIN_CONTENT_URL: window.location.protocol + "//" + window.location.host,
    BOSH_PATH: "/friends/bind",
    CLUB_PENGUIN_AVATAR_URL: window.location.protocol + "//" + window.location.host + "/avatar",
    ...
    ROOMS_PATH: "/config/{0}/rooms.json",
    WORLDS_PATH: "/config/{0}/worlds.json",
    CHARACTERS_PATH: "/config/{0}/characters.json",
    MASCOTS_PATH: "/config/{0}/mascots.json",
    JUMP_STATUS_FOR_ROOMS_URL: window.location.protocol + "//" + window.location.host + "/jump_world",
    JUMP_STATUS_POLLING_INTERVAL: "60000",
    LANDS_PATH: "/config/{0}/lands.json",
    MARKUP_PATH: "/config/markup.json",
    TEXT_PATH: "/config/{0}/text.json",
...
Disney.Social.Environment.init();
Disney.Social.EventAbstract = {
...
Disney.Social.Event.Manager.prototype = Disney.Social.EventAbstract;
Disney.Social.Event.initEventManager();
Disney.Social.API = {
    setCurrentLand: function (e) {
...
Disney.Social.Data.init();
Disney.ClubPenguin = {
    MARGIN: 6,
    GAME_WIDTH: 1710,
    GAME_HEIGHT: 1080,
    GAME_ASPECT_RATIO: 1710 / 1080,
    BUDDY_ICON_POSITION_X: 1293.75,
    BUDDY_ICON_POSITION_Y: 1001.25,
...
Disney.Friends.Data = {};
Disney.Friends.Data.RosterItem = {
    swid: "",
    name: "",
    weight: 0,
    canJumpTo: !1,
...
Disney.Friends.Event.Manager.prototype = Disney.Social.EventAbstract;
Disney.Friends.Event.initEventManager();
Disney.Friends.Event.Warning = {
...
Disney.Friends.API = {
    ...
    connect: function (e, i) {
        Disney.Friends.activeConnection = new Disney.Friends.Connection, Disney.Friends.activeConnection.connect(), Disney.Friends.activeConnection.swid = e
    },
    getSwid: function () {
        var e = null;
    ...
    toggle: function (e) {
        null == e ? Disney.Friends.UI.toggleFriendsSection() : e ? Disney.Friends.UI.showFriendsSection() : Disney.Friends.UI.hideFriendsSection()
    },
...
Disney.Friends.User = function (e) {
    this.connection = e, this.settings = this.roster = null, this.isPreActivated = !1, this.presenceUpdateCount = this.lastPresenceSent = 0, this.presence = {}
};
...
Disney.Friends.Roster.prototype = {
    ...
    getOnlineFriends: function () {
        ...
        for (e in this.friends) {
            ...
            n.presence.status !== Disney.Friends.Presence.Status.OFFLINE && (i[e] = n)
        }
        return i
    },
    getIgnored: function () {
    ...
    requestFriendship: function (e) {
        CP.sendBuddyRequest(e)
    },
    acceptFriendship: function (e) {
        CP.sendAcceptBuddyRequest(e), delete this.pending[e], Disney.Friends.Event.updateListeners(Disney.Friends.Event.PENDING_REMOVE, e)
    },
    rejectFriendship: function (e) {
        CP.sendRejectBuddyRequest(e), delete this.pending[e], Disney.Friends.Event.updateListeners(Disney.Friends.Event.PENDING_REMOVE, e)
    },
    updateFriend: function (e) {
    ...
    populateRoster: function (e) {
        ...
        e.forEach(function (e) {
            i.addFriendItem(e.swid, e.name, e.presence)
        }), Disney.Friends.Event.updateListeners(Disney.Friends.Event.FRIENDS_UPDATE, this.friends)
    },
    populateIgnored: function (e) {
        var i = this;
        this.ignored = {}, e.filter(Boolean).forEach(function (e) {
            e = e.split("|"), i.addIgnoredItem(e[0], e[1])
        }), Disney.Friends.Event.updateListeners(Disney.Friends.Event.IGNORED_UPDATE, this.ignored)
    },
    populatePending: function (e) {
        var i = this;
        e.filter(Boolean).forEach(function (e) {
            e = e.split("|"), e = i.addPendingItem(e[0], e[1]), Disney.Friends.Event.updateListeners(Disney.Friends.Event.PENDING_UPDATE, e)
        })
    },
    ...
    populateBestCharacters: function (e) {
        e.filter(Boolean).forEach(function (e) {
            Disney.Friends.UI.setBestFriend("character_" + e)
        })
    },
    populateCharacterRoster: function (e) {
        var i = this;
        e.filter(Boolean).forEach(function (e) {
            i.addCharacterItem(e.id, e.presence), e.presence == Disney.Friends.Presence.Status.ONLINE && Disney.Friends.Event.updateListeners(Disney.Friends.Event.CHARACTER_INVITE, e.id)
        }), Disney.Friends.Event.updateListeners(Disney.Friends.Event.FRIENDS_UPDATE, this.friends)
    },
    rosterUpdateHandler: function (e, i) {
        if (!1 === i) e = this.removeFriendItem(e), Disney.Friends.Event.updateListeners(Disney.Friends.Event.FRIENDS_REMOVE, e);
        else {
            var n = parseInt(e[2], 10) ? Disney.Friends.Presence.Status.ONLINE : Disney.Friends.Presence.Status.OFFLINE;
            e = this.addFriendItem(e[0], e[1], n), Disney.Friends.Event.updateListeners(Disney.Friends.Event.FRIENDS_NEW, e)
        }
    },
    characterRosterUpdateHandler: function (e) {
        e = this.addCharacterItem(e[0], e[1]), Disney.Friends.Event.updateListeners(Disney.Friends.Event.FRIENDS_NEW, e)
    },
    ignoreUpdateHandler: function (e, i) {
        !1 === i ? (this.removeIgnoredItem(e), Disney.Friends.Event.updateListeners(Disney.Friends.Event.IGNORED_UPDATE, this.ignored)) : (this.addIgnoredItem(e[0], e[1]), Disney.Friends.Event.updateListeners(Disney.Friends.Event.IGNORED_UPDATE, this.ignored))
    },
    buddyRequestHandler: function (e) {
        var i = e[0],
            n = e[1],
            pending = this.addPendingItem(i, n);
        Disney.Friends.Event.updateListeners(Disney.Friends.Event.PENDING_UPDATE, pending)
    },
    ...
    friendOnline: function (e) {
        var i = e[0],
            n = e[1],
            t = e[2],
            s = this.friends[i];
        void 0 !== s && (s.presence.status = Disney.Friends.Presence.Status.ONLINE, s.presence.location.world = n, s.presence.location.room = t, Disney.Friends.Event.updateListeners(Disney.Friends.Event.FRIENDS_UPDATE, s))
    },
    addCharacterItem: function (e, i) {
        var n = Object.create(Disney.Friends.Data.RosterItem),
            t = Object.create(Disney.Friends.Data.Presence);
        return n.character = !0, n.id = e, n.swid = "character_" + e, n.name = Disney.Social.Data.mascots[e].name, n.safeChatName = n.name, t.id = e, t.status = i, t.mobile = !1, t.location = {
            land: "disney:land:clubpenguin",
            room: null,
            world: null
        }, n.presence = t, this.friends[e] = n
    },
    characterOffline: function (e) {
        var i = this.friends[e];
        void 0 !== i && (i.presence.status = Disney.Friends.Presence.Status.OFFLINE, Disney.Friends.Event.updateListeners(Disney.Friends.Event.FRIENDS_UPDATE, i))
    },
    ...
    mascotInvite: function (e) {
        Disney.Friends.Event.updateListeners(Disney.Friends.Event.CHARACTER_INVITE, e)
    },
    addFriendItem: function (e, i, n) {
        var t = Object.create(Disney.Friends.Data.RosterItem),
            s = Object.create(Disney.Friends.Data.Presence);
        return t.swid = e, t.name = i, t.safeChatName = i, t.groups = [], t.jumpAvailable = !1, s.id = e, s.status = n, s.mobile = !1, s.location = {
            land: "disney:land:clubpenguin",
            room: null,
            world: null
        }, t.presence = s, this.friends[e] = t
    },
    ...
    addPendingItem: function (e, i) {
        var n = Object.create(Disney.Friends.Data.RosterItem),
            t = Object.create(Disney.Friends.Data.Presence);
        return n.swid = e, n.name = i, n.safeChatName = i, t.status = Disney.Friends.Presence.Status.PENDING, n.presence = t, this.pending[e] = n
    },
    addIgnoredItem: function (e, i) {
        var n = Object.create(Disney.Friends.Data.RosterItem);
        return n.swid = e, n.name = i, n.safeChatName = i, this.ignored[e] = n
    },
    removeIgnoredItem: function (e) {
        return delete this.ignored[e], e
    }
};
Disney.Friends.Settings = function (e) {
    this.connection = e, this.settings = {}
};
Disney.Friends.Settings.prototype = {
    ...
    settingRequestResultHandler: function (e) {
        if (this.settings = {}, e.length > 0) {
            var i = this;
            i.settings[Disney.Friends.Settings.Constants.BEST_HINT_COUNT] = e.shift(), i.settings[Disney.Friends.Settings.Constants.NOTIFICATION_AWARE] = e.shift(), i.settings[Disney.Friends.Settings.Constants.FRIENDS_ENABLED] = e.shift(), i.settings[Disney.Friends.Settings.Constants.BEST_FRIEND_ENABLED] = e.shift()
        }
...
Disney.Friends.Connection = function (e) {
    this.serviceUri = e, this.password = this.swid = this.user = null, this.connectionStatus = false
};
Disney.Friends.Connection.prototype = {
    ...
    hasConnected: !1,
    connect: function () {
        null === this.user && (this.user = new Disney.Friends.User(this)), this.connectionStatus = true, Disney.Friends.activeUser = this.user;
...
Disney.Friends.Jump = {
    ...
    findUniqueWorlds: function () {
        ...
        for (var s in t = [], n) t.push(Number(s).valueOf());
        return t
    },
...
Disney.Friends.UI = {
    ...
    updateSettings: function () {
        ...
        void 0 !== n && (n = parseInt(n, 10)) && (this.bestCount = n), void 0 !== (n = e.settings[i.BEST_FRIEND_ENABLED]) && n && (this.bestEnabled = !0), void 0 !== (n = e.settings[i.NOTIFICATION_AWARE]) && (n ? (this.notificationAware = !0, this.delay = this.DELAY_NORMAL) : this.notificationAware = !0), n = !1, e.settings[i.FRIENDS_ENABLED] || (n = !0), Disney.Friends.activeUser.setIsPreActivated(n), Disney.Friends.activeUser.isPreActivated && this.preActivatedFriendsPanel()
    },
    preActivatedFriendsPanel: function () {
        if (!$("#D_F_FriendsPanel .preactivated-message").length) {
            ...
            $("#D_F_FriendSection").addClass("preactivated"), $("#D_F_FriendsPanel").prepend('<div class="preactivated-message"><p>' + e + '</p><div class="about-activation"><a href="#" class="button">' + i + "</a></div></div>"), $(".preactivated-message .about-activation .button").click(function (e) {
                e.preventDefault(), CP.handleShowPreactivation(), $("#D_F_FriendSection").fadeOut()
            })
        }
    ...
    getFriendNameBySwid: function (e) {
        var i = "Friend";
        return null == e ? i : (void 0 !== $("#D_F_FriendsGrid").data(e) && (i = $("#D_F_FriendsGrid").data(e).name), i)
    },
    ...
    setLayout: function () {
        ...
        $("#D_F").append(i.markup), $("#D_F_FriendSection").unwrap(), i.setText(), i.setImages(), e.init(), e.HudNotification.reposition(), e.initUIComponents(), e.setTheme(), e.disableSelectText(".D_F"), (e = Disney.Social.ieVer) > 0 && e < 8 && $("a").each(function () {
...
Disney.Friends.UI.Event.init();
Disney.Friends.UI.Images = {
    implicit: {
    ...
    getSrcById: function (e) {
        var i, n = Disney.Friends.UI.Data,
            t = "";
        return n.images.hasOwnProperty(e) ? (i = n.images[e].u, Disney.Social.ieVer > 0 && Disney.Social.ieVer < 8 ? t = Disney.Social.getUrl(i, !0) : (i = i.substr(i.lastIndexOf(".") + 1)) && (t = "data:image/" + i + ";base64," + n.images[e].d), t) : Disney.Social.getUrl(Disney.Friends.UI.Images.implicit.u, !0)
    },
...
Disney.Friends.UI.HudNotification = {
    ...
    notifyInvite: function (e) {
        var i, n;
        if (i = parseInt(e, 10), e[0], !Disney.Social.Data.mascots || !Disney.Social.Data.mascots[i]) return !1;
        n = "character_" + i, i = Disney.Social.Data.mascots[i].name, this.notify(i, this.CHARACTER_INVITE, n)
    },
    reposition: function () {
    ...
    deQueue: function () {
        ...
        for (this.crtArray && this.crtSplice && (this.crtArray.splice(0, this.crtSplice), this.crtArray = null, this.crtSplice = 0), a = this.notifyTypes.length, e = 0; e < a; e++)
            if (n = this.notifyTypes[e], (d = (s = this.notifyArrays[e]).length) > 0) {
    ...
    slidedDown: function () {
        ...
        var e = Disney.Friends.UI.HudNotification;
        e.hidding = !1, "none" === $("#D_F_FriendSection").css("display") && Disney.Friends.API.pollJumpStatus(!1), Disney.Friends.UI.delay = Disney.Friends.UI.DELAY_NORMAL, Disney.Friends.UI.notificationAware || null === Disney.Friends.activeUser || (Disney.Friends.Settings.Constants.NOTIFICATION_AWARE, Disney.Friends.activeUser.settings), e.timeStarted = null, Disney.Friends.API.closedNotification(), e.rescan()
    },
    clearTimer: function () {
        var e = Disney.Friends.UI.HudNotification;
...
Disney.Friends.UI.Friends = {
    ...
    safeChatConnectionUpdate: function (e) {
        ...
        i.find(".D_F_FriendName").each(function () {
            ...
            if (void 0 !== (n = i.data(n))) {
                var s = n.name;
                null != s && (!0 === e && null !== n.safeChatName && (t ? $(t).text("(" + n.safeChatName + ")") : s += " (" + n.safeChatName + ")"), $(this).text(s))
            }
        })
    },
    meUpdate: function () {
    ...
    getTileIdBySwid: function (e) {
        return (e = this.swids.indexOf(e)) < 0 ? null : (e = this.getCoordByIndex(e)) ? this.getTileIdByCoord(e[0], e[1]) : null
    },
    ...
    displayTile: function (e, i) {
        ...
        var d, a, o, c = r.Id,
            l = r.name;
        r = r.status, $(e).children("input[type=hidden]").val(i), (d = $(e).find(".D_F_CharacterCard")[0]) && -1 === i.indexOf("character_") && Disney.Friends.UI.FriendsTile.bindPlayerCard(d), (d = $(e).find(".D_F_PlayerCard")[0]) && 0 === i.indexOf("character_") && (Disney.Friends.UI.FriendsTile.bindCharacterCard(d), Disney.Social.Data.mascots && Disney.Social.Data.mascots[c] && (l = Disney.Social.Data.mascots[c].name)), d || $(e).find(".D_F_CharacterCard"), a = $(e).find(".D_F_FriendAvatar")[0], o = $(e).find(".D_F_FriendAvatarOff")[0], c = $(e).find(".D_F_FriendFavorite")[0], d = $(e).find(".D_F_FriendName")[0], Disney.Friends.UI.getAvatarUriBySwid(a, i, 88, !0), r === n.ONLINE ? $(o).css("display", "none") : $(o).show(), $(a).show(), (n = this.groupNames[s[0]]).substr(0, this.BEST_FRIEND.length) === this.BEST_FRIEND || n.substr(0, this.BEST_CHARACTER.length) === this.BEST_CHARACTER ? (t.setAttrs(c, "20", !1), $(c).attr("title", Disney.Friends.UI.setText("D7"))) : (t.setAttrs(c, "22", !1), $(c).attr("title", Disney.Friends.UI.setText("D10"))), null != d && $(d).text(l), this.updateJump($(e).find(".D_F_FriendJump")[0])
    },
    updateJump: function (e, i) {
        ...
        if ($(e).css("display", "none"), d = $(e).find(".D_F_FriendJumpBtn")[0], $(d).css("display", "none"), t = $(e).find(".D_F_FriendRoom")[0], $(t).text("").css("display", "none"), 0 === r.indexOf("character_") && !i) return !1;
    ...
    updateNew: function (e) {
        var i, n, t;
        this.oldScrollTop = null, e.hasOwnProperty("swid") && (n = e.swid, t = e.name, i = this.processSingleEntry(n, e), this.sortAffected(i), this.updateArrays(n)), this.updateWidget(), (i = Disney.Friends.UI.HudNotification).notify(t, i.FRIEND_ACCEPTANCE, n), Disney.Friends.UI.BarNotification.newFriendCallback(e)
    },
    updateList: function (e) {
        var i, n;
        if (this.oldScrollTop = null, e.hasOwnProperty("character")) i = e.id.toString(), e = this.processSingleEntry(i, e), i = "character_" + i, this.sortAffected(e), 0 === e.length ? this.updateTile(i) : this.updateArrays();
    ...
    processSingleEntry: function (e, i) {
        ...
        }), a !== h.ONLINE ? $("#D_F_FriendsPanel").data(e).cache = {} : u && ($("#D_F_FriendsPanel").data(e).cache = u), a === h.ONLINE && D === h.OFFLINE && (Disney.Friends.UI.Images.setAvatarCache(e, 88, !1), n === this.BEST_CHARACTER || n === this.CHARACTER ? F.notify(s, F.CHARACTER_ONLINE, e) : F.notify(s, F.FRIEND_ONLINE, e, i.presence)), t = this.getGroupIndexBySwid(e), a = this.groupNames.indexOf(n + a), t[0] === a ? (this.groupArrays[t[0]][t[1]] = {
            name: s,
            weight: d,
            swid: e
    ...
    removeFriend: function (e) {
        parseInt(e, 10) > 0 && parseInt(e, 10) < 100 && (e = "character_" + e), $("#D_F_FriendsPanel").data(e, null), $("#D_F_FriendsPanel").removeData(e), this.checkIndexAllFriends(e), e = this.getGroupIndexBySwid(e), this.groupArrays[e[0]].splice(e[1], 1), this.updateArrays()
    }
};
Disney.Friends.UI.FriendsTile = {
    ...
    bindPlayerCard: function (e) {
        $(e).unbind("mousedown").addClass("D_F_PlayerCard").removeClass("D_F_CharacterCard").mousedown(function (e) {
            Disney.Social.stopEvent(e), Disney.Friends.UI.FriendsTile.showPlayerCard(this)
        })
    },
    ...
    toggleBest: function (e) {
        e = $(e).siblings("input[type=hidden]").val(), Disney.Friends.UI.setBestFriend(e), e.indexOf("character_") > -1 ? (e = e.substr(e.lastIndexOf("_") + 1), CP.sendToggleBestCharacter(e)) : CP.sendToggleBestFriend(e)
    }
};
Disney.Friends.UI.Pending = {
    ...
    update: function (e) {
        ...
        return !(!e || !e.swid) && (i = e.swid, !!(n = $.trim(e.name)) && (this.sortedList.push({
            name: n,
            swid: i
        }), this.sortedList.sort(Disney.Friends.UI.Friends.sortNames), void t.updateListeners(t.PENDINGS_UPDATED, e)))
    },
    accept: function (e) {
...
Disney.Friends.UI.AddFriend = {
    ...
    toggleBest: function (e) {
        e = $(e).siblings("input[type=hidden]").val(), Disney.Friends.UI.setBestFriend(e), CP.sendToggleBestFriend(e)
    },
    ...
    foundPlayer: function (e) {
        ...
        var i = Disney.Friends.UI;
        if ($("#D_F_AddFriendBusy").css("display", "none"), null == e || void 0 === e.swid || null === e.swid || void 0 === e.name || null === e.name) return this.showError(i.setText("D17")), this.resetPlacehoder(), !1;
...
$(function () {
    Disney.Social.ieVer = DISNEY_FRIENDS_INI.ieVer;
    Disney.Friends.UI.setLayout();
