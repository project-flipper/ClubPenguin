...
Disney.Social = {
    ...
    init: function () {
        this.getPageLang(), "undefined" != typeof jQuery && (jQuery.fn.allData = function () {
    ...
    getUrl: function () {
        ...
        return (i = arguments[n - 1]) && "boolean" == typeof i ? (i = "", n--) : i = "?v=" + undefined, 1 === n ? (n = Disney.Social.Environment.FRIENDS_BASE_URL + "/", e = arguments[0]) : (n = arguments[0], e = arguments[1]), n + e + i
    },
...
Disney.Social.Environment = {
    DEBUG_CONFIG: "true",
    DEBUG: !0,
    FRIENDS_BASE_URL: window.location.href,
    CLUBPENGUIN_CONTENT_URL: window.location.href + "config",
    BOSH_PATH: "/friends/bind",
    CLUB_PENGUIN_AVATAR_URL: "http://api.localhost/cp/avatar",
    ...
    ROOMS_PATH: "/{0}/rooms.json",
    WORLDS_PATH: "/{0}/worlds.json",
    CHARACTERS_PATH: "/{0}/characters.json",
    MASCOTS_PATH: "/{0}/mascots.json",
    JUMP_STATUS_FOR_ROOMS_URL: "http://jump.friends.go.com/jump_world",
    JUMP_STATUS_POLLING_INTERVAL: "60000",
    LANDS_PATH: "/{0}/lands.json",
    MARKUP_PATH: "/markup.json",
    TEXT_PATH: "/{0}/text.json",
    ...
    updateListeners: function (e) {
        ...
        if (this.gameListeners && this.gameListeners[e]) {
            ...
            for (s = 0; s < this.gameListeners[e].length; s++) {
                ...
                try {
                    console.log(e, i, n), CP.app.friends.emit(e, i)
                } catch (e) { }
            }
        }
    }
...
Disney.Friends.Roster.prototype = {
    ...
    requestFriendship: function (e) {
        CP.app.friends.sendBuddyRequest(e)
    },
    acceptFriendship: function (e) {
        CP.app.friends.sendAcceptBuddyRequest(e), delete this.pending[e], Disney.Friends.Event.updateListeners(Disney.Friends.Event.PENDING_REMOVE, e)
    },
    rejectFriendship: function (e) {
        CP.app.friends.sendRejectBuddyRequest(e), delete this.pending[e], Disney.Friends.Event.updateListeners(Disney.Friends.Event.PENDING_REMOVE, e)
    },
    updateFriend: function (e) {
    ...
    updateFriendItem: function (i, n) {
        console.log(i, n);
        var t, s;
        return i = i.split("|"), e = Object.create(Disney.Friends.Data.RosterItem), e.swid = i.swid, e.name = i.name, e.safeChatName = "", e.groups = [], e.jumpAvailable = !1, t = this.friends[e.swid], s = Disney.Friends.Event.FRIENDS_UPDATE, void 0 === t ? (e.presence = {
            id: i.swid,
            status: i.presence,
            mobile: !1
    ...
    removeCharacterItem: function (e) {
        return delete this.friends[e.id], e
    },
    ...
    updateIgnoredItem: function (e) {
        e = $(e);
        var i = Disney.Social.getNodeFromJid(e.attr("jid")),
            n = e.attr("remove");
...
Disney.Friends.Connection.prototype = {
    ...
    hasConnected: !1,
    connect: function () {
        console.log("Disney.Friends.Connection.connect()"), null === this.user && (this.user = new Disney.Friends.User(this)), this.connectionStatus = true, Disney.Friends.activeUser = this.user;
...
Disney.Friends.UI.FriendsTile = {
    ...
    toggleBest: function (e) {
        console.log("Disney.Friends.UI.FriendsTile.toggleBest()"), e = $(e).siblings("input[type=hidden]").val(), Disney.Friends.UI.setBestFriend(e), CP.app.friends.sendToggleBestFriend(e)
    }
};
...
Disney.Friends.UI.AddFriend = {
    ...
    toggleBest: function (e) {
        e = $(e).siblings("input[type=hidden]").val(), Disney.Friends.UI.setBestFriend(e), CP.app.friends.sendToggleBestFriend(e)
    },
