...
export default class SnowballTrigger {
    ...
    constructor(gameObject: Phaser.GameObjects.Image) {
        ...
        (gameObject as any)["__SnowballTrigger"] = this;
    ...
    static getComponent(gameObject: Phaser.GameObjects.Image): SnowballTrigger {
        return (gameObject as any)["__SnowballTrigger"];
    }
